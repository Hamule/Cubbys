...
void CubbyGame::SetupDataForGame() const
{
	...
	Item* cakeItem = m_pItemManager->CreateItem(
		glm::vec3(52.0f, 10.0f, 26.5f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f),
		"Resources/gamedata/items/BearTrap/bearTrap.item", ItemType::BlockDirt, "Item", false, false, 0.07f);
}
...
bool CubbyGame::CheckInteractions()
{
	...
	if (interaction == false && m_pInteractItem != nullptr)
	{
		...
		// Set Block
		if (m_pInteractItem->GetItemType() == ItemType::BlockDirt)
		{
