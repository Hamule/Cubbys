	...
	m_pRenderer(pRenderer), m_pPlayer(nullptr), m_pCubbySettings(pCubbySettings), m_pQubicleBinaryManager(pQubicleBinaryManager)
{
	...
	AddBlockColorBlockTypeMatching(156, 105, 61, BlockType::Dirt);
	AddBlockColorBlockTypeMatching(55, 172, 2, BlockType::Grass);
	AddBlockColorBlockTypeMatching(241, 238, 119, BlockType::Sand);
