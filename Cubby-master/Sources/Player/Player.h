...
namespace PlayerEquippedProperties
{
	...
	static const int BuildBlock = 1048576;
}
...
public:
	...
	void SetBlock(ItemType s, int x, int y, int z);
	void BlockPos(glm::vec3 ps, glm::vec3 bs,int &x, int &y, int &z);
	// Constants
